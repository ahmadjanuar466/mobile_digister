...
import 'package:digister/screens/security/main/main_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_vlc_player_16kb/flutter_vlc_player.dart';
import 'package:page_transition/page_transition.dart';

class DetailCCTVScreen extends StatefulWidget {
  const DetailCCTVScreen({super.key, required this.url, this.security = false});
...
class _DetailCCTVScreenState extends State<DetailCCTVScreen>
  ...
  void _scaleCCTV() {
    ...
    final zoomed =
        Matrix4.identity()
          ..translateByDouble(x, y, 0, 0)
          ..scaleByDouble(scale, 0, 0, 0);
